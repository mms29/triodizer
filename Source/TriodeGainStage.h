...
class TriodeGainStage
{
    public:
        ...
        float getTriodeVg() const { return w_Triode.Vg; }
        float getTriodeVk() const { return w_Triode.Vk; }
        float getTriodeVp() const { return w_Triode.Vp; }
        float getGridCurrent() const { return w_Triode.ak; } // Approximation
        float getCathodeCurrent() const { return -w_Triode.ak; } // Approximation
        float getPlateCurrent() const { return (w_Triode.ap - w_Triode.Vp) / w_Triode.R0p; }
